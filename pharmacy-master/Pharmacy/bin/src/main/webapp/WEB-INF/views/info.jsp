...
<div id="ovoMenu">
    ...
    <div class="right">
       <span style="color:white">JesteÅ zalogowany jako <b>${logInSessionAdmin.login}</b></span>
...
<a href="logonForm.html">Zaloguj</a>
			...
			<article>
				<header>
				<hgroup>
					 <h1> Kontakt z Apteka </h1>
					 <h2> Dane Kontaktowe: </h2>
				</hgroup>
				</header>
					<h3>Email : dewiktor@gmail.com </br>
						Tel   : 888-333-444 
					 	
					</h3>
					</br>
					
					<a href="glowna.html">Powrot do glownej</a>
	</article>
	   </section>
